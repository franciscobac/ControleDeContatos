...
namespace ControleDeContatos.Repositorio
{
    public class ContatoRepositorio : IContatoRepositorio
    {
        ...
        {
            var retornoListarPorId = _bancoContext.Contatos.FirstOrDefault(x => x.Id == id);
            if (retornoListarPorId == null) throw new Exception("Houve um erro na listagem de contatos!");
